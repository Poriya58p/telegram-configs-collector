...
with open('./last update', 'r') as file:
    ...
    last_update_datetime = datetime.strptime(last_update_datetime, '2025-07-13 21:47:00.000000+0330')
...
url = 'https://raw.githubusercontent.com/Poriya58p/telegram-proxies-collector/main/telegram channels.json'
